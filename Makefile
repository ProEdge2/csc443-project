...
all: $(MAIN_TARGET) $(TEST_MEMTABLE_TARGET) $(TEST_DATABASE_TARGET) $(TEST_SST_FLUSH_TARGET) $(TEST_SST_TARGET) $(TEST_BUFFER_POOL_TARGET)
...
test: $(TEST_MEMTABLE_TARGET) $(TEST_DATABASE_TARGET) $(TEST_SST_FLUSH_TARGET) $(TEST_SST_TARGET) $(TEST_BUFFER_POOL_TARGET)
...
clean:
	rm -f $(MAIN_TARGET) $(TEST_MEMTABLE_TARGET) $(TEST_DATABASE_TARGET) $(TEST_SST_FLUSH_TARGET) $(TEST_SST_TARGET) $(TEST_BUFFER_POOL_TARGET)
...
debug: $(MAIN_TARGET) $(TEST_MEMTABLE_TARGET) $(TEST_DATABASE_TARGET) $(TEST_SST_FLUSH_TARGET) $(TEST_SST_TARGET) $(TEST_BUFFER_POOL_TARGET)

release: CXXFLAGS += -DNDEBUG
release: $(MAIN_TARGET) $(TEST_MEMTABLE_TARGET) $(TEST_DATABASE_TARGET) $(TEST_SST_FLUSH_TARGET) $(TEST_SST_TARGET) $(TEST_BUFFER_POOL_TARGET)

...
TEST_BUFFER_POOL_CLOCK_TARGET = test_buffer_pool_clock
...
TEST_BUFFER_POOL_CLOCK_SOURCES = $(TESTDIR)/test_buffer_pool_clock.cpp $(TESTDIR)/test_framework.cpp
...
all: $(MAIN_TARGET) $(TEST_MEMTABLE_TARGET) $(TEST_DATABASE_TARGET) $(TEST_SST_FLUSH_TARGET) $(TEST_SST_TARGET) $(TEST_BUFFER_POOL_TARGET) $(TEST_BUFFER_POOL_CLOCK_TARGET)
...
$(TEST_BUFFER_POOL_CLOCK_TARGET): $(TEST_BUFFER_POOL_CLOCK_SOURCES) $(TEST_HEADERS) $(HEADERS) $(IMPL_FILES)
	$(CXX) $(CXXFLAGS) -o $(TEST_BUFFER_POOL_CLOCK_TARGET) $(TEST_BUFFER_POOL_CLOCK_SOURCES)

test: $(TEST_MEMTABLE_TARGET) $(TEST_DATABASE_TARGET) $(TEST_SST_FLUSH_TARGET) $(TEST_SST_TARGET) $(TEST_BUFFER_POOL_TARGET) $(TEST_BUFFER_POOL_CLOCK_TARGET)
	./$(TEST_MEMTABLE_TARGET)
	./$(TEST_DATABASE_TARGET)
	./$(TEST_SST_FLUSH_TARGET)
	./$(TEST_SST_TARGET)
	./$(TEST_BUFFER_POOL_TARGET)
	./$(TEST_BUFFER_POOL_CLOCK_TARGET)

run: $(MAIN_TARGET)
	./$(MAIN_TARGET)

clean:
	rm -f $(MAIN_TARGET) $(TEST_MEMTABLE_TARGET) $(TEST_DATABASE_TARGET) $(TEST_SST_FLUSH_TARGET) $(TEST_SST_TARGET) $(TEST_BUFFER_POOL_TARGET) $(TEST_BUFFER_POOL_CLOCK_TARGET)
...
debug: $(MAIN_TARGET) $(TEST_MEMTABLE_TARGET) $(TEST_DATABASE_TARGET) $(TEST_SST_FLUSH_TARGET) $(TEST_SST_TARGET) $(TEST_BUFFER_POOL_TARGET) $(TEST_BUFFER_POOL_CLOCK_TARGET)

release: CXXFLAGS += -DNDEBUG
release: $(MAIN_TARGET) $(TEST_MEMTABLE_TARGET) $(TEST_DATABASE_TARGET) $(TEST_SST_FLUSH_TARGET) $(TEST_SST_TARGET) $(TEST_BUFFER_POOL_TARGET) $(TEST_BUFFER_POOL_CLOCK_TARGET)
